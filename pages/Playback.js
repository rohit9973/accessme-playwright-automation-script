// pages/PlaybackPage.js
// ─────────────────────────────────────────────────────────────────────────────
// Enterprise Page Object — Playback Module
...
export class PlaybackPage extends BasePage {
  constructor(page) {
    super(page);
    this.page = page;
    ...
    this.nowPlayingArtist    = page.locator('[class*="now-playing"] [class*="artist"], [data-testid="now-playing-artist"]').first();
